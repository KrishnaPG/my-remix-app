  ...
  return (
    <header
      className="z-10 m-auto my-0 flex max-h-[80px] min-h-[80px] 
			w-full flex-row items-center justify-between  px-6 max-w-7xl"
    >
      {/* Left Menu. */}
      <Link
        to={!user ? "/" : "/account"}
      ...
      >
        <span className="font-bold text-gray-200">Atrim</span>&nbsp;TBML
        <div className="mx-1" />
        <small className="relative top-[2px] text-sm font-extrabold text-violet-200">v3.2</small>
      </Link>
      ...
      <div className="flex flex-row items-center">
        ...
        {!user && location && (location.pathname === "/" || location.pathname === "/plans") && (
          <>
            <div className="mx-3" />
            <Link
              to="/login"
