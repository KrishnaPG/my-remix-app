...
import { ROUTE_PATH as BILLING_PATH } from '#app/routes/account+/settings.billing.js'
import { ROUTE_PATH as SETTINGS_PATH } from '#app/routes/account+/settings.js'
...
export function Header() {
  ...
  const headerTitle = () => {
    if (location.pathname === DASHBOARD_PATH) return 'My Account'
