...
import { getUserById } from '#app/models/user/get-user'

import { formatUnixDate } from '#app/utils/date'
import { CustomerPortalButton } from '#app/components/stripe/customer-portal-button'
...
export async function loader({ request }: LoaderFunctionArgs) {
  const session = await authenticator.isAuthenticated(request, {
    failureRedirect: '/login?returnTo=/account',
  })
