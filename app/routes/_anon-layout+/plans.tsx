...
import { getDefaultCurrency } from '#app/utils/default-currency'
...
import { CheckoutButton } from '#app/components/stripe/checkout-button'
...
export default function Plans() {
  ...
  const [planInterval, setPlanInterval] = useState<typeof Interval | string>(
    subscription?.interval || Interval.MONTH,
  )

  return (
    <div className="flex w-full flex-col items-center justify-start px-6 md:h-full" style={{ minHeight: "calc(100vh - 80px)" }}>
      {/* Header. */}
